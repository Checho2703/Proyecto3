...
('Escuela Basica El Sol', 'Escuela', 'Pasaje Lunar 789', 'Providencia', '227778899', 'contacto@elsol.cl', 'Ana Torres'),
('Instituto Tecnologico', 'Instituto Profesional', 'Av. Principal 101', 'Las Condes', '229990011', 'admision@instituto.cl', 'Carlos Vera');
...
('11111111-1', 'Juan', 'Perez', 'Garcia', 'juan.perez@example.com', '1234', '911111111', 'Activo', '2005-03-15', 2, 1), -- Alumno del Colegio San Juan (ID_usuario = 1)
